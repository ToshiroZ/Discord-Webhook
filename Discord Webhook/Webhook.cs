...
public class Webhook
{
    ...
    /// </param>
    /// <param name="threadName">The name of the thread to put the webhook message in</param>
    public static async Task SendAsync(string webhookUrl, WebhookObject obj, string? username = null,
    ...
    private WebhookObject SetMessageArguments(WebhookObject obj)
    {
        ...
        obj.AvatarUrl = _username is null ? obj.AvatarUrl : _avatarUrl;
        obj.ThreadName = _threadName ?? obj.ThreadName;
